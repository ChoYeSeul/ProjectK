  ...
  theme.cart = function() {
      ...
      class CartController extends CartViewer {
          constructor() {
              ...
              this.selectorButtonRemove = '.js-product-button-remove-from-cart';
  
              this.popupController();
              this.addToCartController();
              this.removeFromCartController();
          }
          ...
          removeFromCartController() {
              ...
              $body.on('click', this.selectorButtonRemove, function(e) {
                  const $this = $(this);
                  ...
                  events: {
                      'touchstart': function(e) {
                          ...
                          if($megamenuOrDropdown.length) {
                              ...
                              $panel.find('.menu__megamenu, .menu__dropdown').filter('.show').first().parents('.menu__item').find('> a').trigger('mouseleave');
                          }
                      }
                  }
              });
